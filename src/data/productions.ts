...
export const PRODUCTION_EVENTS: ScheduleEvent[] = [
  ...
  // completed Kristina/Jeffrey/Chiara episodes + her Kaitlin author interview.
  {
    ...
    priority: 6,
    status: 'confirmed',
    notes: 'MOVED to Fri 31 Jul 12:00–14:00 (Gareth, 30 Jul). Full 2-hour locked session. Friday now has room since the Eric masterclass was cancelled: studio free from the Marisa × Kwik podcast (ends 11:30) until Rachel\'s block at 15:30. Kaitlin hosts — she comes straight off Main Stage hosting (10:00–12:00), so she has NO gap before this; venues are walkable but she needs to be prepped beforehand. Lee\'s window runs to 2 Aug. Nadir operates on unit 2.',
  },
  {
    id: 'pod-marisa-kwik',
    date: '2026-07-31',
    ...
    title: 'Marisa Peer podcast (YMYR) — guest Jim Kwik',
    type: 'podcast',
    location: STUDIO,
    speakers: ['marisa-peer', 'jim-kwik'],
    crew: UNIT1,
    director: 'gareth',
    cameraOps: ['khairul'],
    status: 'confirmed',
    notes: 'ADDED (Gareth, 30 Jul) — Fri 31 Jul 10:00–11:30, 90 min. Jim Kwik on Marisa\'s "Your Mind, Your Rules" podcast. Opens Friday in the studio: both are free that morning (Kwik has no Friday stage session; Marisa is clear until her 14:30 makeup call), and the room is empty until Lee\'s 12:00 interview. No Vishen, so it does not touch his 11:00–12:00 Main Stage content slot. Unit 1 (Khairul), Gareth directs. Makeup call 09:00–10:00.',
  },
  {
