...
export const PRODUCTION_EVENTS: ScheduleEvent[] = [
  ...
  // ---------- SAT 1 AUG ----------
  {
    ...
    crew: UNIT2,
    status: 'tentative',
    notes: 'Her last day. Before the Vishen AI Accelerator takes the main crew.',
  },
  {
  ...
  // ---------- SUN 2 AUG (wrap day) ----------
  {
    ...
    gareth: true,
    status: 'conflict',
    notes: 'His departure day — confirm flight time before locking.',
  },
  {
    id: 'mc-marisa',
    date: '2026-08-02',
  ...
  },
  {
    ...
    gareth: true,
    status: 'tentative',
    notes: 'Reduced suite straight after her masterclass.',
  },
  {
    id: 'workshop-eric',
    date: '2026-08-02',
    ...
    crew: FULL,
    status: 'tentative',
    notes: 'Final shoot of the sprint. Eric is in Estonia through 2 Aug.',
  },
]
