...
export const PRODUCTION_EVENTS: ScheduleEvent[] = [
  ...
  // another day — "we can't make time for it." Airtable record marked Cancelled.
  {
    ...
    priority: 6,
    status: 'confirmed',
    notes: 'Marisa\'s own podcast, Jeffrey guest — Jeffrey\'s LAST day (flies 26 Jul), so it stays Saturday. RE-TIMED to 15:15–16:45 (Gareth, 21 Jul): Regan\'s masterclass now holds the studio 12:00–15:00, so this runs right after with a 15-min set flip, and wraps 16:45 — 15 min before the crew moves to Regan\'s 17:00 accelerator. Matt (coordinator) asked for 4:00–5:30pm; that DOESN\'T work — it collides with the crew being on Regan\'s 5pm accelerator. This 3:15–4:45pm window is the fit. Marisa\'s 2nd podcast of the day (after Kristina 09:00).',
  },
