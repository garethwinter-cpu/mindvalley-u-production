...
export const PRODUCTION_EVENTS: ScheduleEvent[] = [
  ...
  },
  {
    ...
    cameraOps: ['kuhan'],
    status: 'confirmed',
    notes: 'PRIORITY (Gareth, 21 Jul). Accelerator upsell ads, shot on the Main Stage right before Regan\'s 17:00 Wealth Code accelerator, then rolls straight into it. Makeup 2:00pm at the Nuune Hotel (travels in). Kuhan shoots (+ Gareth directs) so the studio unit (Khairul/Nadir) stays on the Shi Heng Yi interview (15:45–16:30); Kuhan then continues onto the accelerator on the same stage. On the Main Stage, NOT the studio. Regan\'s window closes 27 Jul.',
  },
  {
  ...
  },
  {
    ...
    title: 'Kaitlin O’Toole — content shoot',
    type: 'production',
    location: STUDIO,
    speakers: ['kaitlin'],
    gareth: true,
    ...
    priority: 5,
    status: 'confirmed',
    notes: 'ADDED per Gareth (23 Jul) — 1-hour Kaitlin content shoot, Sun 26 10:00–11:00 (studio opens 10am on the weekend). Runs first, then Vishen\'s ads 11:00–12:00, then Kaitlin\'s Marisa interview 12:15. Gareth + unit 1. Kaitlin glams off-site (green room gated until 10) — see makeup.',
  },
  {
    id: 'makeup-shoot-kaitlin-sun',
    date: '2026-07-26',
    start: '08:45',
    end: '09:45',
    title: 'Makeup & wardrobe — Kaitlin O’Toole',
    ...
    speakers: ['kaitlin'],
    crew: ['makeup'],
    notes: 'Off-site glam for Kaitlin\'s 10:00 content shoot — the weekend green room/studio is locked until 10am, so she preps at the hotel and travels in. NOTE: hotel assumed Nuune (the author-prep hotel) — confirm Kaitlin\'s actual hotel.',
  },
  {
    id: 'int-shy',
    date: '2026-07-26',
