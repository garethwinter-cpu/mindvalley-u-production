...
export const PRODUCTION_EVENTS: ScheduleEvent[] = [
  ...
  },
  {
    ...
    priority: 2,
    status: 'conflict',
    notes: '⚠ WINDOW CHANGE: Priestley departs 21 Jul — 22 Jul interview no longer works. Move to ≤21. Reassigned from Kaitlin to Gareth (13 Jul prioritization pass).',
  },
  {
    id: 'pod-natalie',
    date: '2026-07-22',
  ...
  },
  {
    ...
    priority: 2,
    status: 'conflict',
    notes: 'Straight after his podcast. Reassigned from Kaitlin to Gareth (13 Jul prioritization pass). ⚠ CONFLICT: overlaps Gareth\'s own pod-jamie-sea (1:15-2:00pm, same studio) by 30 min — needs a time move.',
  },
  {
    id: 'pod-jamie-sea',
    date: '2026-07-30',
  ...
  },
  {
    ...
    priority: 4,
    status: 'conflict',
    notes: 'Window unknown — pairs with her podcast slot. Reassigned from Kaitlin to Gareth (13 Jul prioritization pass) — only a 15-min gap after his own pod-jamie-sea (same studio), very tight but not overlapping.',
  },
