...
export const PRODUCTION_EVENTS: ScheduleEvent[] = [
  ...
  },
  {
    ...
    priority: 5,
    status: 'confirmed',
    notes: 'ADDED per Gareth (23 Jul) — 1-hour Vishen ads shoot, Sun 26 11:00–12:00. Weekend studio opens 10am; this sits before the 12:15 Kaitlin/Marisa interview (15-min reset). Vishen free until his 2pm Lorin podcast. Gareth + unit 1. CONTENT TBC — confirm which product/campaign to label + brief.',
  },
  {
    id: 'int-shy',
    date: '2026-07-26',
