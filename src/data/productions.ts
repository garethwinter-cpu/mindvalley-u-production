...
export const PRODUCTION_EVENTS: ScheduleEvent[] = [
  ...
  },
  {
    ...
    cameraOps: ['kuhan'],
    status: 'tentative',
    notes: 'Right after Regan\'s masterclass + assets wrap (13:00) — camera-ready. RE-TIMED from 12:15 (21 Jul) when the masterclass moved to 11:00–12:30 at Vishen\'s request. Woodblock + Kuhan; she walks over from the Energiakeskus studio. Her window closes 27 Jul.',
  },
  {
    id: 'tom-jade',
    date: '2026-07-23',
  ...
  // ---------- THU 23 JUL ----------
  {
    ...
    cameraOps: CAMERA_CREW,
    status: 'tentative',
    notes: 'MOVED to 11:00–12:30 (Gareth, 21 Jul) — Vishen\'s call: 10am was too early for him, wanted it after 11. Ends 12:30, leaving a 30-min studio reset before the locked Chiara×Marisa podcast at 13:00. This crosses into Thursday afternoon, which Regan had previously flagged as unavailable — Gareth is informing Regan directly (not asking permission). MC DNA 2.0 format; script doc in Airtable. Vishen has no stage slots the 23rd.',
  },
  {
    id: 'assets-regan',
    date: '2026-07-23',
    ...
    cameraOps: CAMERA_CREW,
    status: 'tentative',
    notes: 'CONSOLIDATED into the masterclass session: captured in the 30 min right after it while Regan is still lit, mic\'d and in makeup. MOVED with the masterclass to 12:30–13:00 (Gareth, 21 Jul, Vishen pushed the masterclass to 11:00). Now runs into the early afternoon — Gareth is informing Regan (her old "morning only" note superseded). SCOPE: 30 min = the trimmed priority 2–3 items. NOTE: snappy guest-swap turnaround into the locked Chiara×Marisa podcast at 13:00 (same studio) — crew flips the 2-person podcast set as Chiara + Marisa come off makeup.',
  },
  {
