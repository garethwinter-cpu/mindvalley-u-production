...
export const PODCAST_GUEST_BRIEFS: PodcastGuestBrief[] = [
  {
    ...
    oneBigIdea: `You don't get rich by working harder — you raise your financial "thermostat." Money is energy: energy is the cause, money is the effect, and almost everyone has it backwards.`,
    founderValue: `Earns a new founder audience: hard, contrarian money mechanics (Make/Keep/Multiply, 30/30/30/10, leverage, "sell it before you build it") wrapped in an identity-and-energy story — practical enough for operators, human enough to travel. The episode's job is to hand founders something they can act on Monday, not to sell anything.`,
    ...
    vishenNotes: `META-ANGLE worth telling on-air: it was you (via Ken Honda at A-Fest) who set his book deal in motion — a genuine shared-world story, told for the audience, not as a Mindvalley plug. PRODUCTION (from Social Media Mastery): open on a hook in the first line (a perspective shift, not a bio); hold him to the one big idea and cut the AI-tooling tangents; don't let him give the payoff early on the story beats (Steve Foley, Slovakia, the lost-and-regained million) — make the viewer wait; his contrarian lines ("saving is bad", "don't pay your mortgage") are the highest-performing clip candidates (perspective shift + high stakes on money); mine 3-4 self-contained moments where his answer is quotable on its own. TWO PERSONAS: wealth-and-energy John (rich, emotional, useful to founders) vs AI-futurist John (product demos) — steer hard to the former.`,
    watchOuts: [
      `WEALTH DRAGONS — not in his Mindvalley content, but external reporting ties him to a UK property-education company that hit financial/reputational trouble. Do NOT raise as fact; vet with legal before any reference; be ready if he volunteers the "lost and made back a fortune" comeback.`,
      `Self-reported numbers (£100k/keynote, "35 houses in 6 months", unicorn stats) are his claims, not verified — attribute, don't assert.`,
      `He makes flat financial calls ("don't pay your mortgage", Bitcoin) — frame as his opinion, never advice.`,
      `He live-demos his own funnel software — steer him off the sales pitch.`,
    ],
  },
  {
    id: 'jeffrey-allen',
