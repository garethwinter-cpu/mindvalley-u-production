...
export const DAYS: DayMeta[] = [
  ...
  { date: '2026-08-02', label: 'Sun 2 Aug', theme: 'Wrap — studio pack/travel', week: 2, unavailable: true },
  { date: '2026-08-03', label: 'Mon 3 Aug', theme: 'Post-event', week: 2, unavailable: true },
  { date: '2026-08-04', label: 'Tue 4 Aug', theme: 'Post-event', week: 2, unavailable: true },
  { date: '2026-08-05', label: 'Wed 5 Aug', theme: 'Post-event', week: 2, unavailable: true },
]
...
const EVENT_ITEMS: ScheduleEvent[] = [
  ...
  { id: 'jul21-vishen', date: '2026-07-21', start: '14:00', end: '15:00', title: 'Vishen', type: 'stage-talk', location: MAIN_STAGE, speakers: ['vishen'], vishen: true, status: 'done' },
  ...
  { id: 'jul21-vishen-photo', date: '2026-07-21', start: '15:15', end: '15:35', title: 'Portraits — Vishen', type: 'portrait', crew: ['meng'], speakers: ['vishen'], vishen: true, status: 'done', notes: 'Location TBD' },
  ...
  { id: 'jul27-shy-fireside', date: '2026-07-27', start: '14:00', end: '15:00', title: 'Shi Heng Yi Fireside with Vishen (→ Scaling Wisdom launch episode)', type: 'stage-talk', location: MAIN_STAGE, speakers: ['shi-heng-yi', 'vishen'], vishen: true, crew: ['nadir', 'khairul'], notes: 'Recorded ON STAGE and cut into the FIRST Scaling Wisdom podcast episode (per Gareth\'s call with Vishen, 14 Jul). This is one of Vishen\'s five high-star podcasts — no separate studio recording. CREW: Nadir + Khairul film it (Gareth, 26 Jul) — they strike the studio after the Shi × Kaitlin interview (ends 13:15), haul kit to the Black Box (~45 min, into a live event), then move it all back up to the studio after (15:00–15:45) for the afternoon productions. This is why the studio sits idle 13:15–15:45 and Marisa\'s podcast + Vishen\'s ads run later.' },
  ...
  { id: 'jul30-kwik-3', date: '2026-07-30', start: '14:00', end: '15:00', title: 'Jim Kwik (stage)', type: 'stage-talk', location: MAIN_STAGE, speakers: ['jim-kwik'], notes: 'Per the MVU Overview sheet, the 2–3pm Main Stage slot is Jim Kwik solo. Corrected 14 Jul — the old "Maya 25min + Kristina? 25min" was wrong; Kristina is not listed in this slot. (Maya\'s talks moved to Tue 28 Small Hall + Thu 30 Terrace Hall per the 27 Jul source audit — she is not on any stage this Thu-14:00 slot.)' },
  { id: 'jul28-maya-smallhall', date: '2026-07-28', start: '15:00', end: '16:00', title: 'Maya Raichoora — Small Hall talk (Adults)', type: 'stage-talk', location: COMMUNITY, speakers: ['maya-raichoora'], notes: 'CHANGED (source audit, 27 Jul): Author x Event Airtable now places Maya\'s adult Small Hall talk on TUE 28 Jul 15:00–16:00 (was Thu 30 14:00–14:30 in our data). Full hour now. Tech rehearsal Tue 28 12:00–12:15 (Small Hall) precedes it. She also has a separate Juniors talk Thu 30 (see jul30-maya-juniors).' },
  { id: 'jul30-maya-juniors', date: '2026-07-30', start: '10:00', end: '10:45', title: 'Maya Raichoora — Juniors talk (10–12s)', type: 'stage-talk', location: 'Terrace Hall (Youth Programs)', speakers: ['maya-raichoora'], notes: 'ADDED (source audit, 27 Jul): Author x Event Airtable shows Maya on the Terrace Hall stage for the Juniors (10–12) programme Thu 30 Jul 10:00–10:45. This is why her studio interview cannot sit at that time.' },
