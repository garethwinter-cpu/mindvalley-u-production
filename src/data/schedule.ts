...
const EVENT_ITEMS: ScheduleEvent[] = [
  ...
  { id: 'jul27-shy-fireside', date: '2026-07-27', start: '14:00', end: '15:00', title: 'Shi Heng Yi Fireside with Vishen (→ Scaling Wisdom launch episode)', type: 'stage-talk', location: MAIN_STAGE, speakers: ['shi-heng-yi', 'vishen'], vishen: true, notes: 'Recorded ON STAGE and cut into the FIRST Scaling Wisdom podcast episode (per Gareth\'s call with Vishen, 14 Jul). This is one of Vishen\'s five high-star podcasts — no separate studio recording.' },
